...
Originally from Daniel Mai's repository and almost all contents are credited to him.
...
There are two brew versions - one regular and the other cask version.
** regular version
...
* Installing java and plantuml.jar
Install Java with brew - it is required of PlantUML
#+being_src sh
...
(setq user-full-name "James Kang"
      user-mail-address "marchkang@gmail.com")
#+end_src
...
(setq org-plantuml-jar-path
      (expand-file-name "~/.emacs.d/plantuml-1.2018.9.jar"))
#+end_src
...
** COMMENT EverNote
I am already hooked with evernote
gem install evernote_oauth
#+begin_src emacs-lisp
(use-package evernote
  :ensure t )
#+end_src
** Elfeed
...
** COMMENT (removed from melpa) Zoom-frm
